...
<div class="swipgle-backend-pages">
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('add.price.store') }}" method="POST">
                    @csrf
                    <div class="form-group mb-3 row">
                        <label class="form-label col-3 col-form-label">{{__('Space :')}} <span class="point-red">*</span></label>
                        <div class="col">
                            <div class="input-group">
                                <input type="number" name="space" class="form-control" placeholder="1073741824" required>
                    ...
                    <div class="text-right">
                        <button class="btn btn-primary" type="submit">{{__('Add price')}}</button>
                    </div>
                    </form>
                </div>
            </div>
