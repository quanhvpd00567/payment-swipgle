            ...
            <div class="message">
               <div class="row">
                  <div class="col-auto">
                     ...
                     <span class="avatar" style="background-image: url({{ avatar($message->user->avatar) }})"></span>
                     @else 
                     <span class="avatar" style="background-image: url({{ avatar('default.png') }})"></span>
                     @endif
                  </div>
                  <div class="col">
                  ...
                  <div class="col-auto align-self-center">
                     ...
                     <a href="{{ route('delete.message', $message->id) }}" onclick="return confirm('are you sure?')" class="btn btn-danger btn-sm ms-3">
